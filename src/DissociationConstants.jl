...
Base.@kwdef struct Pᴮᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.000416
    a₁ :: Float64    =   35.0
    a₂ :: Float64    =   1.0
end
...
Base.@kwdef struct Pᶜᵃᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.02127
    a₁ :: Float64    =   40.078
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pᶠᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.000068
    a₁ :: Float64    =   35.0
end
...
Base.@kwdef struct Pˢᴼ⁴ᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.1400
    a₁ :: Float64    =   96.062
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pᴺᴴ⁴ᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.0001
    a₁ :: Float64    =   17.031
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pᴾᴼ⁴ᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.0001
    a₁ :: Float64    =   94.971
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pˢⁱᴼ³ᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.0001
    a₁ :: Float64    =   60.084
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pᴴ²ˢᵀᴼᵀ{Float64}
    a₀ :: Float64    =   0.0001
    a₁ :: Float64    =   34.082
    a₂ :: Float64    =   1.80655
end
...
Base.@kwdef struct Pᵈⁱᶜₖ₀{Float64}
    a₀ :: Float64 = -60.2409
    a₁ :: Float64 =  93.4517
    a₂ :: Float64 =  23.3585
    b₀ :: Float64 =   0.023517
...
Base.@kwdef struct Pᵈⁱᶜₖ₁ᵣ₉₃{Float64}
    a₀ :: Float64 =     2.83655
    a₁ :: Float64 = -2307.1266
    a₂ :: Float64 = -   1.5529413
    b₀ :: Float64 = -   0.20760841
    b₁ :: Float64 = -   4.0484
    b₂ :: Float64 =     0.08468345
    b₃ :: Float64 = -   0.00654208
    v₀ :: Float64 = -  25.5
    v₁ :: Float64 = -   0.151
    v₂ :: Float64 =     0.1271
    k₀ :: Float64 = -   3.08e-3
...
Base.@kwdef struct Pᵈⁱᶜₖ₂ᵣ₉₃{Float64}
    ...
    a₁ :: Float64 = -3351.6106
    a₂ :: Float64 = -   0.2005743
    b₀ :: Float64 = -   0.106901773
    b₁ :: Float64 = -  23.9722
    b₂ :: Float64 =     0.1130822
    b₃ :: Float64 = -   0.00846934
    v₀ :: Float64 = -  15.82
    v₁ :: Float64 =     0.321
    v₂ :: Float64 = -   0.0219
    k₀ :: Float64 =     1.13e-3
...
Base.@kwdef struct Pᵈⁱᶜₖ₁ₘ₉₅{Float64}
    a₀ :: Float64 =     2.18867
    a₁ :: Float64 = -2275.0360
    a₂ :: Float64 = -   1.468591
    b₀ :: Float64 = -   0.138681
...
Base.@kwdef struct Pᵈⁱᶜₖ₁ₗ₀₀{Float64}
    a₀ :: Float64 =    61.2172
    a₁ :: Float64 = -3633.86
    a₂ :: Float64 = -   9.67770
    b₀ :: Float64 =     0.011555
...
Base.@kwdef struct Pᴴ²ᴼₖ₁{Float64}
    a₀ :: Float64 =    148.9802
    a₁ :: Float64 = -13847.26
    a₂ :: Float64 = -   23.6521
    b₀ :: Float64 = -    5.977
...
Base.@kwdef struct Pᴾᴼ⁴ₖ₁{Float64}
    a₀ :: Float64 =   115.54
    a₁ :: Float64 = -4576.752
    a₂ :: Float64 = -  18.453
    b₀ :: Float64 =     0.69171
...
Base.@kwdef struct Pˢⁱᵗₖ₁{Float64}
    a₀ :: Float64 =    117.40
    a₁ :: Float64 = - 8904.2
    a₂ :: Float64 = -   19.334
    b₀ :: Float64 =      3.5913
...
Base.@kwdef struct Pᴴ²ˢₖ₁{Float64}
    a₀ :: Float64 =     225.838
    a₁ :: Float64 = - 13275.3
    a₂ :: Float64 = -    34.6435
    a₃ :: Float64 =       0.3449
...
Base.@kwdef struct Pᴺᴴ⁴ₖ₁{Float64}
    a₀ :: Float64 = -    0.25444
    a₁ :: Float64 = - 6285.33
    a₂ :: Float64 =      0.0001635
    b₀ :: Float64 =      0.46532
...
Base.@kwdef struct Pᴴᶠᵦ₁{Float64}
    a₀ :: Float64 =     12.641
    a₁ :: Float64 = - 1590.2
    a₂ :: Float64 = -    1.525
    v₀ :: Float64 = -    9.78
...
Base.@kwdef struct Pᴴᶠₖ₁{Float64}
    a₀ :: Float64 = -  9.68
    a₁ :: Float64 =  874.0
    a₂ :: Float64 =    0.111
    v₀ :: Float64 = -  9.78
...
Base.@kwdef struct Pᴴˢᴼ⁴ₖ₁{Float64}
    a₀ :: Float64 =     141.328
    a₁ :: Float64 = -  4276.1
    a₂ :: Float64 = -    23.093
    b₀ :: Float64 =     324.57
...
Base.@kwdef struct Pᶜᵃˡᶜⁱᵗᵉₛₚ{Float64}
    a₀ :: Float64 = - 171.9065
    a₁ :: Float64 = -   0.077993
    a₂ :: Float64 =  2839.319
    a₃ :: Float64 =    71.595
...
Base.@kwdef struct Pᵃʳᵃᵍᵒⁿⁱᵗᵉₛₚ{Float64}
    a₀ :: Float64 = - 171.945
    a₁ :: Float64 = -   0.077993
    a₂ :: Float64 =  2903.293
    a₃ :: Float64 =    71.595
