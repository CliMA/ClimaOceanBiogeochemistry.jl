...
P2Cratio = 117
############# True heatmap #############
ax_True1 = Axis(fig[1, 1]; xlabel = "t (days)", ylabel = "Depth (m)", title = "Modeled POC flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_True1 = heatmap!(ax_True1, 1:1:365, zw, P2Cratio .* avg_TrueFlux1; colorrange = (0, 7.5),colormap = :thermal, interpolate = true) 
Colorbar(fig[1, 2], hm_True1; flipaxis = false)
ylims!(ax_True1, -1000, -200)

ax_True2 = Axis(fig[2, 1]; xlabel = "t (days)", ylabel = "Depth (m)", title = "Modeled POC flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_True2 = heatmap!(ax_True2, 1:1:365, zw, P2Cratio .* avg_TrueFlux2; colorrange = (0, 7.5),colormap = :thermal, interpolate = true) 
...
############# Martin heatmap #############
ax_Martin1 = Axis(fig[1, 3]; xlabel = "t (days)", ylabel = "Depth (m)", title = "Martin flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_Martin1 = heatmap!(ax_Martin1, 1:1:365, zw, P2Cratio .* avg_MartinFlux1; colorrange = (0, 7.5),colormap = :thermal, interpolate = true) 
Colorbar(fig[1, 4], hm_Martin1; flipaxis = false)
ylims!(ax_Martin1, -1000, -200)

ax_Martin2 = Axis(fig[2, 3]; xlabel = "t (days)", ylabel = "Depth (m)", title = "Martin flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_Martin2 = heatmap!(ax_Martin2, 1:1:365, zw, P2Cratio .* avg_MartinFlux2; colorrange = (0, 7.5),colormap = :thermal, interpolate = true) 
Colorbar(fig[2, 4], hm_Martin2; flipaxis = false)
ylims!(ax_Martin2, -1000, -200)

# ax_Martin3 = Axis(fig[3, 5]; xlabel = "t (days)", ylabel = "Depth (m)", title = "Ave. Martin-derived flux (mmol m⁻² d⁻¹)", aspect = 1)
...
############# Diff heatmap #############
ax_diff1 = Axis(fig[1, 5]; xlabel = "t (days)", ylabel = "Depth (m)", title = "True - Martin flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_diff1 = heatmap!(ax_diff1, 1:1:365, zw, P2Cratio .* (avg_TrueFlux1 .- avg_MartinFlux1); colorrange = (-2,2),colormap = :balance, interpolate = true) 
Colorbar(fig[1, 6], hm_diff1; flipaxis = false)
ylims!(ax_diff1, -1000, -200)

ax_diff2 = Axis(fig[2, 5]; xlabel = "t (days)", ylabel = "Depth (m)", title = "True - Martin flux (mmol m⁻² d⁻¹)", aspect = 1)
hm_diff2 = heatmap!(ax_diff2, 1:1:365, zw, P2Cratio .* (avg_TrueFlux2 .- avg_MartinFlux2); colorrange = (-2,2),colormap = :balance, interpolate = true) 
Colorbar(fig[2, 6], hm_diff2; flipaxis = false)
ylims!(ax_diff2, -1000, -200)

# ax_diff3 = Axis(fig[4, 5]; xlabel = "t (days)", ylabel = "Depth (m)", title = "True - Martin-derived flux (mmol m⁻² d⁻¹)", aspect = 1)
