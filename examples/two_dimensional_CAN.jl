...
simulation = Simulation(model; Δt = 5minutes, stop_time=365.25*500days) 
...
hm_w = heatmap!(ax_w, xw, zw, wₙ; colorrange = (-5e-5,5e-5), colormap = :balance) 
Colorbar(fig[2, 4], hm_w; flipaxis = false)

ax_PO4 = Axis(fig[3, 1]; xlabel = "x (m)", ylabel = "z (m)", title = "[PO₄] (μM)", aspect = 1)
hm_PO4 = heatmap!(ax_PO4, xw, zw, PO4ₙ; colorrange = (0,3.5),colormap = :jet1) 
...
hm_PO4 = heatmap!(ax_PO4, xw, zw, PO4_final; colorrange = (0, 4),colormap = :jet1) 
...
hm_POP = heatmap!(ax_POP, xw, zw, POP_final; colorrange = (0,0.055),colormap = :jet1) 
Colorbar(fig_can[2, 2], hm_POP; flipaxis = false)
# NO3 concentrations
ax_NO3 = Axis(fig_can[2, 3]; xlabel = "x (m)", ylabel = "z (m)", title = "[NO₃] (μM)", aspect = 1)
hm_NO3 = heatmap!(ax_NO3, xw, zw, NO3_final; colorrange = (0,60), colormap = :jet1) 
...
hm_DOP = heatmap!(ax_DOP, xw, zw, DOP_final; colorrange = (0,0.35),colormap = :jet1) 
...
hm_NCP = heatmap!(ax_NCP, xw, zw, 1000*NCP_final; colorrange = (0,0.055),colormap = :jet1) 
